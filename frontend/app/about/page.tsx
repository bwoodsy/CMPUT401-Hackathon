      ...
      <section className="mx-auto max-w-5xl px-6 py-12 space-y-10">
        ...
        <div className="space-y-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Build a rapid prototype using web or front-end frameworks</li>
          ...
          <h2 className="text-2xl font-semibold">Technology Recommendations</h2>
          <ul className="list-disc list-inside ml-8 space-y-2">
            <li>
              <strong>Backend:</strong> Django or NextJS
            </li>
            <li>
              <strong>Frontend:</strong> React, React Native, Flutter, or NextJS
            </li>
          </ul>
